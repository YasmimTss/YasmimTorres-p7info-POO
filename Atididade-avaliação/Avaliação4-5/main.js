...
//Criar um Cliente 
let cliente = new cliente_1.Cliente(1, "Zamini du lov", 100, "200.345.987-11", tipo_cliente_1.TipoCliente.PESSOA_FISICA);
console.log("=========================");
console.log(cliente);
console.log("=========================");
...
let p1 = new produto_1.Produto(1, 150, "Feijão magico", 8.00);
let p2 = new produto_1.Produto(2, 200, "Oregano vencido", 7.00);
let p3 = new produto_1.Produto(3, 300, "Laranja", 5.50);
let p4 = new produto_1.Produto(4, 350, "CusCuz", 8.50);
let p5 = new produto_1.Produto(5, 400, "Banana amassada", 1.70);
...
let itnf5 = new item_nota_fiscal_1.ItemNotaFiscal(5, 5, 10, p4);
