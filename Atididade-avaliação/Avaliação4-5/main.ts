...
let cliente = new Cliente(1, "Zamini du lov", 100, "200.345.987-11",TipoCliente.PESSOA_FISICA);
console.log("=========================");
console.log(cliente);
console.log("=========================");
...
let p1 = new Produto(1, 150, "Feijão magico", 8.00);
let p2 = new Produto(2, 200,"Oregano vencido", 7.00);
let p3 = new Produto(3, 300, "Laranja", 5.50);
let p4 = new Produto(4, 350, "CusCuz", 8.50);
let p5 = new Produto(5, 400, "Banana amassada", 1.70);
